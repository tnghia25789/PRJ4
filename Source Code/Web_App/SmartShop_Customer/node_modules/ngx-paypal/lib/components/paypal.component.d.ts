...
export declare class NgxPaypalComponent implements OnChanges, OnDestroy, AfterViewInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NgxPaypalComponent, "ngx-paypal", never, { "config": "config"; "registerScript": "registerScript"; }, { "scriptLoaded": "scriptLoaded"; }, never, never>;
}
